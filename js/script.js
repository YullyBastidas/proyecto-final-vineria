...
// este objeto busca validar que los campos esten llenos antes de enviar
const campos = {
    usuario: false,
    nombre: false,
    password: false,
...
// esta funcion valida que cada campo cumpla los requisitos con las expresiones regulares con el valos de los inputs
...
// aqui se valida que el password2 sea identico al password1
...
const validarPassword2 = () => {
    ...
    if(inputPassword1.value !== inputPassword2.value){
        ...
        document.querySelector(`#grupo__password2 .formulario__input-error`).classList.add('formulario__input-error-active');
        ...
        document.querySelector(`#grupo__password2 .formulario__input-error`).classList.remove('formulario__input-error-active');
        campos['password'] = true;
    }
}


// aqui se escuchan los eventos cada vez que suelto una tecla o hago click fuera de un input
...
// evento para enviar el formulario verificando que todos los campos este llenos 
formulario.addEventListener('submit', (e) => {
    ...
    if(campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && terminos.checked){
        ...
        // esto borra el mensaje de exito
        ...
        // esto borra el mensaje de error en 5 segundos
        setTimeout(() => {
